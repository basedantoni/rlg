...
export const insertLevelDefinitionSchema = createInsertSchema(levelDefinitions).omit({
        createdAt: true,
        updatedAt: true,
});
...
export type NewlevelDefinitionParams = z.infer<typeof insertLevelDefinitionParams>;
export type UpdatelevelDefinitionParams = z.infer<typeof updateLevelDefinitionParams>;
